...
const profile = {
  ...
  return (
    <>
      <main className="bg-black text-slate-100 min-h-screen">
        <section
          ...
          >
            ...
            <div className="w-full lg:w-1/2 mb-12 lg:mb-0 animate__animated animate__fadeInLeft relative">
              ...
              <div className="relative mb-6 sm:mb-8">
                <h1 className="text-5xl md:text-7xl font-extrabold mb-6 bg-gradient-to-r from-slate-100 via-blue-300 to-slate-400 bg-clip-text text-transparent whitespace-nowrap">
                  Shubham Kumar
                </h1>
              ...
              <div className="relative mb-8 sm:mb-12 max-w-xl">
                <p className="text-base sm:text-xl text-gray-300/90 leading-relaxed">
                    Full-Stack Developer 🚀 | Problem Solver 🔧 | Learning MERN Stack 💻✨ | GitHub for Version Control 🔧
                </p>
              </div>
              ...
              <div className="flex flex-col sm:flex-row gap-4 sm:gap-6 animate__animated animate__fadeInUp animate__delay-2s">
                ...
                {/* Contact Button */}
                <a
                  href="https://drive.google.com/file/d/1aF0xd0S-B_ugURQ-MRXAWCYrohxbfXxf/view?usp=drive_link"
              ...
              <div className="gradient-border">
                <div className="code-window bg-[#091121]">
                  <div className="window-header">
                    <div className="window-dot bg-blue-500"></div>
