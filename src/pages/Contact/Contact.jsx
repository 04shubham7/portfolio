...
export default function Contact() {
  ...
  const handleSubmit = async (e) => {
    ...
    form.append("access_key", "862dee27-36a6-45cd-afb9-4236959e716b"); // Replace with your Web3Forms access key
  ...
  return (
    <main className="pt-20 lg:pt-[0rem] bg-black min-h-screen">
        ...
        <div className="container mx-auto">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="space-y-8">
              <div>
                <h2 className="text-4xl font-bold mb-4 bg-gradient-to-r from-slate-100 via-pink-300 to-slate-400 bg-clip-text text-transparent drop-shadow-[0_0_10px_rgba(255,180,220,0.7)]">
                  Get in Touch
                </h2>
              ...
              <div className="space-y-6">
                <div className="flex items-center space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-white">shubham040711@gmail.com</p>
                  </div>
                </div>
                ...
                <div className="flex items-center space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-white">Bhagalpur, 813210</p>
                  </div>
                </div>
              </div>
            </div>
